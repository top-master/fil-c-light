...
test8(void)
{
    int** src =
        zgc_alloc(27);
    int** origSrc = zgc_alloc(27);
    int** dst = zgc_alloc(27);
    int** origDst = zgc_alloc(27);
    zmemmove_union(
        (char*)dst + 0,
        (char*)src + 0,
        27);
...
test16(void)
{
    int** src =
        zgc_alloc(28);
    int** origSrc = zgc_alloc(28);
    int** dst = zgc_alloc(28);
    int** origDst = zgc_alloc(28);
    zmemmove_union(
        (char*)dst + 1,
        (char*)src + 1,
        27);
...
test48(void)
{
    int** src =
        zgc_alloc(29);
    int** origSrc = zgc_alloc(29);
    int** dst = zgc_alloc(29);
    int** origDst = zgc_alloc(29);
    zmemmove_union(
        (char*)dst + 1,
        (char*)src + 1,
        28);
