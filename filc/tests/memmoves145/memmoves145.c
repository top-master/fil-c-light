...
test12(void)
{
    int** src =
        zgc_alloc(42);
    int** origSrc = zgc_alloc(42);
    int** dst = zgc_alloc(42);
    int** origDst = zgc_alloc(42);
    zmemmove_union(
        (char*)dst + 6,
        (char*)src + 6,
        36);
...
test20(void)
{
    int** src =
        zgc_alloc(43);
    int** origSrc = zgc_alloc(43);
    int** dst = zgc_alloc(43);
    int** origDst = zgc_alloc(43);
    zmemmove_union(
        (char*)dst + 7,
        (char*)src + 7,
        36);
...
test52(void)
{
    int** src =
        zgc_alloc(44);
    int** origSrc = zgc_alloc(44);
    int** dst = zgc_alloc(44);
    int** origDst = zgc_alloc(44);
    zmemmove_union(
        (char*)dst + 7,
        (char*)src + 7,
        37);
