...
test0(void)
{
    int** src =
        zgc_alloc(21);
    int** origSrc = zgc_alloc(21);
    int** dst = zgc_alloc(21);
    int** origDst = zgc_alloc(21);
...
test16(void)
{
    int** src =
        zgc_alloc(22);
    int** origSrc = zgc_alloc(22);
    int** dst = zgc_alloc(22);
    int** origDst = zgc_alloc(22);
    zmemmove_union(
        (char*)dst + 4,
        (char*)src + 4,
        18);
...
test80(void)
{
    int** src =
        zgc_alloc(23);
    int** origSrc = zgc_alloc(23);
    int** dst = zgc_alloc(23);
    int** origDst = zgc_alloc(23);
    zmemmove_union(
        (char*)dst + 5,
        (char*)src + 5,
        18);
