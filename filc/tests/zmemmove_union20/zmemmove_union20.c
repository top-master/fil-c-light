...
int main()
{
    // Test copying nested structures with pointers using zmemmove
    ...
    // Copy structure
    zmemmove_union(&dst, &src, sizeof(struct nested_ptrs));
    ...
    zprintf("Nested structure zmemmove succeeded\n");
